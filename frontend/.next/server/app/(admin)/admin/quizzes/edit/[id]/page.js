...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 93468)), "/frontend_app/src/app/(admin)/admin/quizzes/edit/[id]/page.tsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 95654)), "/frontend_app/src/app/not-found.tsx"],
    ...
    const pages = ["/frontend_app/src/app/(admin)/admin/quizzes/edit/[id]/page.tsx"];
    ...
    const originalPathname = "/(admin)/admin/quizzes/edit/[id]/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 68065))
...
/* harmony import */ var _app_admin_admin_quizzes_add_AddQuiz_module_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(59618);
/* harmony import */ var _app_admin_admin_quizzes_add_AddQuiz_module_scss__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_app_admin_admin_quizzes_add_AddQuiz_module_scss__WEBPACK_IMPORTED_MODULE_5__);
...
const EditQuiz = ({ id })=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: (_app_admin_admin_quizzes_add_AddQuiz_module_scss__WEBPACK_IMPORTED_MODULE_5___default().wrapper),
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_app_admin_components__WEBPACK_IMPORTED_MODULE_3__/* .QuizzesForm */ .xd, {
                id: id
            }),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (EditQuiz);
...
;// CONCATENATED MODULE: ./src/app/(admin)/admin/quizzes/edit/[id]/components/EditQuiz.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/frontend_app/src/app/(admin)/admin/quizzes/edit/[id]/components/EditQuiz.tsx`)
...
/* harmony default export */ const EditQuiz = (__default__);
;// CONCATENATED MODULE: ./src/app/(admin)/admin/quizzes/edit/[id]/page.tsx



const Page = ({ params: { id } })=>/*#__PURE__*/ jsx_runtime_.jsx(EditQuiz, {
        id: id
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [381,4256,188,8875,6852,3256,5193], () => (__webpack_exec__(74132)));
